				...
				<div class="card card-primary card-outline">
					<div class="card-body box-profile">
						...
						<ul class="list-group list-group-unbordered mb-3">
							...
							<b>Contacto:</b> <a class="float-right"><?php echo $appCompany[0]['company_contact']; ?></a>
							</li>
							<li class="list-group-item">
							<b>Número contacto:</b> <a class="float-right"><?php echo $appCompany[0]['company_movil']; ?></a>
							</li>
							<li class="list-group-item">
							<b>Correo:</b> <a class="float-right"><?php echo $appCompany[0]['company_email']; ?></a>
							</li>
						</ul>
            <p class="text-center">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal" id="<?php echo $appCompany[0]['id_company']; ?>" >
              Editar Info <i class="fas fa-edit"></i>
            </button>
            </p>
					</div>
				</div>
      ...
      <div class="col-md-3">
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <h3 class="profile-username text-center">Configuración correo</h3>
            <ul class="list-group list-group-unbordered mb-3">
              <li class="list-group-item">
              <b>Host:</b> <a class="float-right"><?php echo $datosParametricos[0]["parametro_valor"];; ?></a>
              </li>
              <li class="list-group-item">
              <b>User name:</b> <a class="float-right"><?php echo $datosParametricos[1]["parametro_valor"]; ?></a>
              </li>
              <li class="list-group-item">
              <b>From name:</b> <a class="float-right"><?php echo $datosParametricos[3]["parametro_valor"]; ?></a>
              </li>
            </ul>
          </div>
        </div>
