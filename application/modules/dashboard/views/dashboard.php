				...
				<div class="col-lg-12">	
					<div class="alert alert-danger">
						...
						<strong>Hora alerta: </strong><?php echo $infoAlerta['hora_alerta']; ?><br>
							...
							<div class="progress">
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/contestaron");?>" >
...
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/no_contestaron");?>" >
...
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/no_contestaron");?>" >
							...
							<div class="progress">
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/si");?>" >
...
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/no");?>" >
...
<a href="<?php echo base_url("dashboard/alerta_especifica/" . $lista['id_alerta'] . "/admin/no_contestaron");?>" >
						...
						<p>
							...
							<div class="progress">
								...
								<div class="progress-bar progress-bar-success" role="progressbar" style="width:50%">
								Disponible <?php echo number_format($valorCantidad) . " (" . $porcentajeTotales . "%)"; ?> 
								</div>
							</div> 
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
						...
						<?php
							...
							foreach ($infoSitios as $lista):
								...
								echo "<td >";
echo "<a href='" . base_url('report/mostrarSesiones/' . $lista['id_sitio'] . '/admin' ) . "'>" . $lista['nombre_sitio'] . "</a>";
								echo "</td>";
