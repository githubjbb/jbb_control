		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-legal fa-fw"></i> CARGAR EXAMINANDOS
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-legal"></i> Seleccionar archivo para cargue de examinandos
				</div>
				<div class="panel-body">
				
					<div class="alert alert-info">
						Seleccionar archivo para cargue de examinandos
					</div>				
        ...
        <form name="formCargue" id="formCargue" role="form" method="post" enctype="multipart/form-data" action="<?php echo site_url("/admin/do_upload/cargar_informacion_examinandos"); ?>">
            <div class="row">
