<script type="text/javascript" src="<?php echo base_url("assets/js/validate/novedades/otra.js"); ?>"></script>
...
$(function(){ 
	$(".btn-success").click(function () {	
            ...
            $.ajax ({
                type: 'POST',
				url: base_url + '/novedades/cargarModalOtras',
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-download"></i> LISTA DE OTRAS NOVEDADES
				</div>
				<div class="panel-body">
					<button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modal" id="x">
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar otra novedad
					</button><br>
<?php
...
?> 
				...
				?>				
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
						...
						?>
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="<?php echo $lista['id_otra']; ?>" >
										Editar <span class="glyphicon glyphicon-edit" aria-hidden="true">
									</button>
									
									<br><br>

<button type="button" class="btn btn-danger btn-xs" id="<?php echo $lista['id_otra']; ?>" >
