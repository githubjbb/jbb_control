<script type="text/javascript" src="<?php echo base_url("assets/js/validate/novedades/cambio_cuadernillo_editar.js"); ?>"></script>
...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Formulario de Cambio de Cuadernillo</h4>
	<strong>Sitio: </strong> <?php echo $information?$information[0]["nombre_sitio"]:""; ?>
	<br><strong>Código DANE: </strong> <?php echo $information?$information[0]["codigo_dane"]:""; ?>
</div>
...
<div class="modal-body">
	...
	<form name="form" id="form" role="form" method="post" >
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group text-left">
					<label for="type" class="control-label">Motivo cambio de cuadernillo : *</label>
					<select name="motivo" id="motivo" class="form-control" >
						<option value=''>Select...</option>
						<?php for ($i = 0; $i < count($motivos); $i++) { ?>
							<option value="<?php echo $motivos[$i]["id_motivo_novedad"]; ?>" <?php if($information[0]["fk_id_motivo_novedad"] == $motivos[$i]["id_motivo_novedad"]) { echo "selected"; }  ?>><?php echo $motivos[$i]["nombre_motivo_novedad"]; ?></option>	
						<?php } ?>
					</select>
				</div>
			</div>
