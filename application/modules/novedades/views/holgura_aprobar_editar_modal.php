<script type="text/javascript" src="<?php echo base_url("assets/js/validate/novedades/holgura_editar.js"); ?>"></script>
...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Formulario de Holguras</h4>
