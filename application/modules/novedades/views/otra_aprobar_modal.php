<script type="text/javascript" src="<?php echo base_url("assets/js/validate/novedades/otra_aprobar.js"); ?>"></script>

<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	<h4 class="modal-title" id="exampleModalLabel">Formulario para Aprobar otra novedad
	</h4>
</div>
