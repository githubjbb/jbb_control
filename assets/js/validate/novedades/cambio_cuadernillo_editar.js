$( document ).ready( function () {
	...
	$(".btn-danger").click(function () {	
			...
			if(window.confirm('Esta seguro de eliminar el cambio de cuadernillo?'))
			{
					$(".btn-danger").attr('disabled','-1');
					$.ajax ({
						type: 'POST',
						url: base_url + 'novedades/eliminar_cambio_cuadernillo',
						...
						success: function(data){
							...
							{	                                                        
								...
								var url = base_url + "novedades/cambio_cuadernillo";
	...
	$("#btnSubmit").click(function(){		
		...
		if ($("#form").valid() == true){
				...
				$.ajax({
					type: "POST",	
					url: base_url + "novedades/update_cambio_cuadernillo",	
					data: $("#form").serialize(),
					dataType: "json",
